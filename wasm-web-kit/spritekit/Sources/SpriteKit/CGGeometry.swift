...
public struct CGPoint: Equatable, Hashable, Sendable {
    ...
    public init() { x = 0
    y = 0 }
    public init(x: CGFloat, y: CGFloat) { self.x = x
    self.y = y }
    public init(x: Int, y: Int) { self.x = CGFloat(x)
    self.y = CGFloat(y) }
...
public struct CGSize: Equatable, Hashable, Sendable {
    ...
    public init() { width = 0
    height = 0 }
    public init(width: CGFloat, height: CGFloat) { self.width = width
    self.height = height }
    public init(width: Int, height: Int) { self.width = CGFloat(width)
...
public struct CGVector: Equatable, Hashable, Sendable {
    ...
    public init() { dx = 0
    dy = 0 }
    public init(dx: CGFloat, dy: CGFloat) { self.dx = dx
    self.dy = dy }
...
public struct CGRect: Equatable, Sendable {
    ...
    public init() { origin = .zero
    size = .zero }
    public init(origin: CGPoint, size: CGSize) { self.origin = origin
    self.size = size }
