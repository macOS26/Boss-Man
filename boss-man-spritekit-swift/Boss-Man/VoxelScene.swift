...
final class VoxelScene: SKScene, BossControllerDelegate, SKTouchResponder {
    ...
    private func projectSprites(dirX: Double, dirY: Double, planeX: Double, planeY: Double) {
        ...
        for item in all {
            ...
            // Hide anything behind the wall directly in front of it: nearest wall over the sprite's
            // small footprint (min, not max) so a dot one aisle over never shows through a wall.
